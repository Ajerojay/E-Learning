...
const stats = [
  { title: "Total Students", value: "25", action: "View Students", icon: "👩‍👧‍👦", tone: "blue", progress: 83 },
  { title: "Today’s Attendance", value: "22", action: "Present Today", icon: "📋", tone: "green", progress: 88 },
  { title: "Activities Today", value: "8", action: "View Activities", icon: "📝", tone: "pink", progress: 64 },
  { title: "Stars Given", value: "450", action: "View Rewards", icon: "⭐", tone: "purple", progress: 75 },
];
...
const recent = [
  { avatar: "👧🏻", text: "Sofia earned “Reading Star”", time: "2 min ago", badge: "🌟" },
  { avatar: "👦🏻", text: "Liam completed Colors", time: "15 min ago", badge: "🎨" },
  { avatar: "👧🏻", text: "Emma finished Shapes", time: "30 min ago", badge: "🔺" },
];
  ...
  return (
    <div className="td-page">
      <aside className="td-sidebar">
        ...
        <div className="td-bear" aria-hidden="true">🧸<span>💗</span></div>
      </aside>
        ...
        <header className="td-header">
          ...
          <div className="td-header-actions" ref={headerActionsRef}>
            ...
            <div className="td-popover-wrap">
              ...
              ><span>👩🏻‍🏫</span><span><strong>Teacher Maria</strong><small>Kindergarten Teacher</small></span><ChevronDown className={profileOpen ? "rotated" : ""} size={17} /></button>
              {profileOpen && (
                <div className="td-popover td-profile-menu" role="menu">
                  <div className="td-menu-person"><span>👩🏻‍🏫</span><div><strong>Maria Santos</strong><small>maria@learnease.test</small></div></div>
  ...
  <div className="td-panel-body">
    {isWeekend ? (
      ...
      <>
        ...
        {profileView && (
          <div className="td-modal-backdrop" role="presentation" onMouseDown={() => setProfileView(null)}>
            <section className="td-profile-modal" role="dialog" aria-modal="true" aria-labelledby="td-modal-title" onMouseDown={(event) => event.stopPropagation()}>
              ...
              <div className="td-modal-avatar">👩🏻‍🏫</div>
        ...
        {toast && <div className="td-toast" role="status"><span>✨</span>{toast}</div>}
      </main>
    </div>
  );
}
