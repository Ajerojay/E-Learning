...
const AppSignIn = lazy(() => import("./MobileApp/AppSignIn"));
const AppSignUp = lazy(() => import("./MobileApp/AppSignUp"));
const AppStudentAccess = lazy(() => import("./MobileApp/AppStudentAccess"));
const AppStudentPage = lazy(() => import("./MobileApp/AppStudentPage"));
const AppLessonPage = lazy(() => import("./MobileApp/AppLessonPage"));
const AppColorsQuestPage = lazy(() => import("./MobileApp/AppColorsQuestPage"));
const AppPhonicsQuestPage = lazy(() => import("./MobileApp/AppPhonicsQuestPage"));
const AppLogicQuestPage = lazy(() => import("./MobileApp/AppLogicQuestPage"));
const AppNumbersQuestPage = lazy(() => import("./MobileApp/AppNumbersQuestPage"));
const AppLetterQuestPage = lazy(() => import("./MobileApp/AppLetterQuestPage"));
const AppShapesQuestPage = lazy(() => import("./MobileApp/AppShapesQuestPage"));
const AppParentDashboard = lazy(() => import("./MobileApp/AppParentDashboard"));
const AppParentChildren = lazy(() => import("./MobileApp/AppParentChildren"));
const AppParentProgress = lazy(() => import("./MobileApp/AppParentProgress"));
const AppAdminPage = lazy(() => import("./MobileApp/AppAdminPage"));
const AppAdminStudents = lazy(() => import("./MobileApp/AppAdminStudents"));
const AppTeacherDashboard = lazy(() => import("./MobileApp/AppTeacherDashboard"));
